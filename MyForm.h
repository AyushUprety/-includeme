	...
	private: System::Void Button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (textBox9->Text == "" || textBox10->Text == "" || textBox7->Text == "") {
			...
			try
			{
				...
				String^ name = textBox10->Text;
				String^ password = textBox7->Text;
				MySqlCommand^ cmd = gcnew MySqlCommand("INSERT INTO `register_data`(`id`, `name`, `password`, `data`, `remarks`,`data2`) VALUES ('" + id + "','" + name + "','" + password + "','0','remarks','0')", con);
				MySqlDataReader^ dr;
				con->Open();
