...
namespace Includeme {
	...
	//
	static int count, for_scope = 0,absent_count;
	/// <summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(777, 3);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(165, 143);
			...
			this->richTextBox1->Size = System::Drawing::Size(100, 141);
			...
			this->richTextBox2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->richTextBox2->Location = System::Drawing::Point(385, 3);
			this->richTextBox2->Name = L"richTextBox2";
			this->richTextBox2->Size = System::Drawing::Size(384, 141);
			...
			this->richTextBox3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->richTextBox3->Location = System::Drawing::Point(111, 3);
			this->richTextBox3->Name = L"richTextBox3";
			this->richTextBox3->Size = System::Drawing::Size(268, 141);
			this->richTextBox3->TabIndex = 5;
			this->richTextBox3->Text = L"";
			this->richTextBox3->TextChanged += gcnew System::EventHandler(this, &MyForm15::RichTextBox3_TextChanged);
			// 
			// tableLayoutPanel1
			// 
			...
			this->tableLayoutPanel1->Location = System::Drawing::Point(57, 263);
			this->tableLayoutPanel1->Name = L"tableLayoutPanel1";
			this->tableLayoutPanel1->RowCount = 1;
			this->tableLayoutPanel1->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 50)));
			this->tableLayoutPanel1->Size = System::Drawing::Size(1096, 149);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Verdana", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(948, 3);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(144, 143);
			...
			this->label1->Location = System::Drawing::Point(572, 206);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(155, 38);
			...
			this->label2->Location = System::Drawing::Point(244, 206);
			...
			this->label3->Location = System::Drawing::Point(88, 206);
			this->label3->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(61, 38);
			...
			this->ClientSize = System::Drawing::Size(1167, 683);
			this->Controls->Add(this->label3);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->label1);
			this->Controls->Add(this->tableLayoutPanel1);
			this->MaximumSize = System::Drawing::Size(1189, 739);
			this->MinimumSize = System::Drawing::Size(739, 739);
	...
	private: System::Void Button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try
		{
			...
			else// (for_scope <= (dt->Rows->Count - 1))
			{
				...
				String^ str = lastRow[6]->ToString();

				absent_count = Int32::Parse(str);
				absent_count ++;
				...
				MySqlCommand^ cmd = gcnew MySqlCommand("UPDATE `register_data` SET `remarks`= '" + rema1 + "',`data2`='" + absent_count.ToString() + "' WHERE `sn`='" + lastRow[0] + "' ", con);
				con->Open();
